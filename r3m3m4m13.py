...
def run():
    ...
    # podniesienie wózka
    base.c_motor.run_angle(125, -305)
    wait(10)
    ...
    robot_move.jazda_prosto(510, predkosc_max=1000, pauza=10)#560
