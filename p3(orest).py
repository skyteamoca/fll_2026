...
def run():
    ...
    robot_move.jazda_prosto(152, predkosc_max=800, dystans_hamowania=100, pauza=200)
    ...
    # podniesienie wózka
    base.c_motor.run_angle(200, -295)
    wait(1000)
    ...
    # podjazd do foki
    robot_move.jazda_prosto(390, predkosc_max=900, pauza=10)
    
    # podnoszenie foki
    base.c_motor.run_angle(1000, -300)
    wait(100)
    robot_move.jazda_prosto(-148, predkosc_max=1000, pauza=10)
    robot_move.spin_turn_v1(-36, predkosc_max=500, Kp=4.0, Ki=0.1)
    ...
    robot_move.smooth_turn(235, -70, 500, pauza=10)
