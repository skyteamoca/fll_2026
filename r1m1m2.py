...
def run():
    ...
    #going for mission 2
    robot_move.jazda_prosto(100, predkosc_max=500, pauza=10)
    robot_move.spin_turn_small(-40.5, 260, pauza=10)
    robot_move.jazda_prosto(165, predkosc_max=800, pauza=10)
    robot_move.spin_turn_small(2, 500, pauza=10)
    robot_move.spin_turn_small(-2, 500, pauza=10 )
    robot_move.jazda_prosto(-50, 500, pauza=50)
    # #catching the artfact in m2
    robot_move.nakladka_prawa(-180, predkosc=600, pauza=10)
